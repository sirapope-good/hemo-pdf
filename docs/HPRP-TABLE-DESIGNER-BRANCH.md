...
- Production **clinical-08/09 consent**: `layoutMode: designer` — ThaiUR header + dense `clinical.consent-narrative` (intro / paragraphs / signatures remain C#). Report-data adapter `consent` + nested `header` for preset binds.
