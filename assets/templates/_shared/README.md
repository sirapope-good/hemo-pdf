...
Copy into `assets/templates/{template-id}/layout.json` when scaffolding a new form report. Prefer `clinical-07-lab/layout.json` when the report needs a `data-grid`.
