...
public sealed class GeneratePdfOperationFilter : IOperationFilter
{
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        if (!string.Equals(context.ApiDescription.ActionDescriptor.RouteValues["action"], "Generate", StringComparison.Ordinal))
            return;
